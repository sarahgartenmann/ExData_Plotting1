...
# change all columns except for "Date" and "Time" from factor to numeric 
# (2880obs, 9 variables)
datasub4[,3:9] <- sapply(datasub4[,3:9], as.numeric)
...
with(datasub5, {
  ...
  plot(datetime, Sub_metering_1, 
    ...
    lines(datasub5$datetime, datasub3$Sub_metering_2,
        type = "l",
        col = "red")
    # Add line for Sub_metering_2
